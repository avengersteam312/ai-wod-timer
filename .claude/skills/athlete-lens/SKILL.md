...
# consumers:
#   - standalone: yes — users invoke via /athlete-lens
#   - auto-trigger: yes — Claude invokes when reviewing features or timer output from user POV
#   - subagent: no
#   - cross-skill: yes — judge prompt block usable in promptfoo/*.yaml; invocable by /regex to validate workout pattern coverage
---
